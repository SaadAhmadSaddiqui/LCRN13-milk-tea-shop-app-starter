			...
			<Animated.FlatList
				...
				renderItem={({ item }) => {
					return (
						...
						>
							{/* Image */}
							<Image source={images.strawberryBackground} resizeMode="contain" style={{ flex: 1 }} />
							{/* Name */}
							<Text style={{ color: COLORS.red, ...FONTS.h1, fontSize: fs[27] }}>{item.name}</Text>
...
PromoDeals.propTypes = {
	...
	onPromoTabPress: PropTypes.any,
	promoScrollViewRef: PropTypes.any,
};
