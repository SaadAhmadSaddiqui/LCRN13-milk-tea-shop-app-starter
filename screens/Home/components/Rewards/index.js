...
const Rewards = ({ navigation }) => {
	return (
		<TouchableOpacity style={styles.rewardsContainer} onPress={() => navigation.navigate("Rewards")}>
			{/* Reward Cup */}
			<View style={styles.rewardCupContainer}>
				<ImageBackground source={icons.reward_cup} resizeMode="contain" style={styles.cupImageBackground}>
